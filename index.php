    ...
    <section class="hosting" id="hosting">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <p>What would you spend for <b><i class="context">20 pesos</i></b>? Have your website hosted here! For <b><i class="context">P20.00 a month ( $0.44 ) </i></b>, you'll have your own web space running on LNMP stack. Suitable for personal websites, small business sites, prototyping or you just want to impress your prof for your thesis!</p>
		    <br /><br />
